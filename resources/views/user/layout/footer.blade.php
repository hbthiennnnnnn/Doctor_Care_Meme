        ...
        <div class="button-contact" id="phone-vr">
            <div class="phone-vr">
                ...
                <div class="phone-vr-img-circle">
                    <a class="pps-btn-img" href="tel:+082.234.5959" alt="Gọi điện thoại" style="text-decoration: none"><i
                            class="fa fa-phone" style="color: #fff"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-footer">
                        <h2>Về chúng tôi</h2>
                        <p>
                            Lấy hoạt động khám chữa bệnh phục vụ cộng đồng là mũi nhọn, bên cạnh thương hiệu y tế hàng
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-footer">
                        <h2>Giờ làm việc</h2>
                        <p>
                            59 Lê Thành Phương, Phường Phương Sài, TP. Nha Trang
                        </p>
                        <ul class="time-sidual">
                            <li class="day">Thứ 2 - Chủ Nhật: 06h00 - 11h30; 13h30 - 20h00.</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-12">
